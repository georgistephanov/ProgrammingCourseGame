...
public class SpikeMan extends Enemy {
	...
	private static final BodyImage standingImage = new BodyImage("data/spikeMan_stand.png", 4);
	private static final BodyImage [] walkingImages = {
			new BodyImage("data/spikeMan_walk1.png", 4),
			new BodyImage("data/spikeMan_walk2.png", 4)
	};
